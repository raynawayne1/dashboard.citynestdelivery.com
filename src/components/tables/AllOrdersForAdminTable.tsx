...
export default function AllOrdersForAdminTable({
        ...
        <div className="container mx-auto p-4">
            <div className="flex flex-wrap justify-center gap-6">
                <div className="bg-white shadow-lg rounded-lg p-6 w-full sm:w-80 lg:w-1/2 border border-dashed border-[rgb(70,95,255)]">
                    <h2
                        className={`text-2xl font-semibold mb-4 text-center ${errorMessage && orders.length === 0
                            ? 'text-[rgb(70,95,255)]'
                            : 'text-red-600'
                            }`}
                    >
                                    ...
                                    orders.map((order, index) => (
                                        <TableRow key={index}>
                                            <TableCell className="px-5 py-4 sm:px-6 text-start">
                                                {trucatText(order.serviceName, 2)}
                                            </TableCell>
                                            <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                                                {trucatText(order.categoryName, 2)}
                                            </TableCell>
                                            <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                                                <a href={order.link} target="_blank" rel="noopener noreferrer">
                                                    {truncateBycharacter(order.link ? order.link : "No Link", 15)}
                                                </a>
                                            </TableCell>
                                            <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
