...
// Updated generateOrderEmailHtml function
      ...
      <div class="container">
          ...
          <div class="content">
              ...
              <div class="details">
                  ...
                  <p><strong>Amount:</strong> <span style="color: #465fff;">${amount} NGN</span></p>
                  <p><strong>Charge:</strong> ${formatAmount(charge)} NGN</p>
                  <p><strong>Average Time:</strong> ${averageTime}</p>
                  <p><strong>Status:</strong> ${status}</p>
                  <p><strong>Email:</strong> ${email ? email : 'Not Provided'}</p>
                  <p><strong>Date:</strong> ${formattedDate}</p>
                  
                  <!-- Conditionally render username or link -->
