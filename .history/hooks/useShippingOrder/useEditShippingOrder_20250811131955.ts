Argument of type '(url: string) => { file: undefined; preview: string; progress: number; uploaded: boolean; }' is not assignable to parameter of type '(value: IUploadImage, index: number, array: IUploadImage[]) => { file: undefined; preview: string; progress: number; uploaded: boolean; }'.
  Types of parameters 'url' and 'value' are incompatible.
    Type 'IUploadImage' is not assignable to type 'string'.ts(2345)
